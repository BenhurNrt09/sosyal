    ...
    return (
        <header className="flex h-24 items-center justify-between px-8 bg-transparent pt-4">
            ...
            <div className="flex items-center gap-4">
                <Button variant="ghost" size="icon" className="relative text-slate-400 hover:text-violet-600 hover:bg-violet-50 dark:hover:bg-slate-800 rounded-xl w-12 h-12">
