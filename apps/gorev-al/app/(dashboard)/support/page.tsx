...
export default function SupportPage() {
    ...
    return (
        <div className="space-y-6">
            {/* Header */}
            <div className="bg-gradient-to-r from-violet-600 to-purple-600 rounded-[2rem] p-8 text-white shadow-lg shadow-violet-100/50">
            ...
            <div className="grid md:grid-cols-3 gap-6">
                <div className="bg-white rounded-[2rem] p-6 border border-slate-100 hover:shadow-md transition-shadow">
                    ...
                    <a href="mailto:destek@parala.com" className="text-violet-600 font-black text-sm hover:underline">
                        destek@parala.com
                    </a>
                </div>
                ...
                <div className="bg-white rounded-[2rem] p-6 border border-slate-100 hover:shadow-md transition-shadow">
                    ...
                    <a href="tel:+905559876543" className="text-violet-600 font-black text-sm hover:underline">
                        +90 555 987 65 43
                    </a>
                </div>
                ...
                <div className="bg-white rounded-[2rem] p-6 border border-slate-100 hover:shadow-md transition-shadow">
                    ...
                    <p className="text-violet-600 font-black text-sm">09:00 - 18:00</p>
                </div>
            </div>
