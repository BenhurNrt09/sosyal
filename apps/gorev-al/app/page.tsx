                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex justify-between items-center">
                        ...
                        <div className="flex items-center gap-2.5">
                            ...
                            />
                            <span className="text-2xl font-bold tracking-tight text-slate-900">PARALA</span>
                        </div>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                        <div className="bg-gradient-to-br from-slate-800 to-slate-900 rounded-lg p-6 text-center border border-slate-700/50 hover:scale-105 transition-transform">
                            <div className="text-4xl lg:text-5xl font-black text-transparent bg-clip-text bg-gradient-to-r from-violet-400 to-purple-400 mb-2">50K+</div>
                            <div className="text-sm text-slate-400 font-semibold">Tamamlanan Görev</div>
                        </div>
                        <div className="bg-gradient-to-br from-slate-800 to-slate-900 rounded-lg p-6 text-center border border-slate-700/50 hover:scale-105 transition-transform">
                            <div className="text-4xl lg:text-5xl font-black text-transparent bg-clip-text bg-gradient-to-r from-violet-400 to-purple-400 mb-2">12K+</div>
                            <div className="text-sm text-slate-400 font-semibold">Aktif Kullanıcı</div>
                        </div>
                        <div className="bg-gradient-to-br from-slate-800 to-slate-900 rounded-lg p-6 text-center border border-slate-700/50 hover:scale-105 transition-transform">
                            <div className="text-4xl lg:text-5xl font-black text-transparent bg-clip-text bg-gradient-to-r from-violet-400 to-purple-400 mb-2">₺250K+</div>
                            <div className="text-sm text-slate-400 font-semibold">Ödenen Tutar</div>
                        </div>
                        <div className="bg-gradient-to-br from-slate-800 to-slate-900 rounded-lg p-6 text-center border border-slate-700/50 hover:scale-105 transition-transform">
                            <div className="text-4xl lg:text-5xl font-black text-transparent bg-clip-text bg-gradient-to-r from-violet-400 to-purple-400 mb-2">4.9/5</div>
            ...
            <footer className="bg-slate-900 border-t border-slate-800 pt-16 pb-8 text-slate-400">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid md:grid-cols-4 gap-12 mb-12">
                        <div className="col-span-2">
                            <div className="flex items-center gap-2.5 mb-6">
                                ...
                                />
                                <span className="text-2xl font-bold text-white">PARALA</span>
                            </div>
                    ...
                    <div className="pt-8 border-t border-slate-800 text-center text-sm">
                        <p>&copy; 2026 Parala. Tüm hakları saklıdır.</p>
                    </div>
                </div>
            </footer>
        </div>
