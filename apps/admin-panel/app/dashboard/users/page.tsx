    ...
    return (
        <div className="space-y-6">
                    ...
                    <div className="bg-white rounded-[2.5rem] p-10 w-full max-w-sm shadow-2xl animate-in zoom-in-95 duration-200">
                        ...
                        <div className="space-y-4">
                            ...
                            <Button
                                ...
                                disabled={isUpdating}
                                className="w-full h-12 bg-violet-600 text-white font-bold rounded-xl"
                            >
            ...
            <div className="flex items-center justify-between">
                ...
                <Button className="bg-gradient-to-r from-indigo-600 to-violet-600 text-white hover:from-indigo-700 hover:to-violet-700 rounded-xl">
                                    ...
                                    <tr key={user.id} className="hover:bg-slate-50/50 transition-colors">
                                        <td className="py-4">
                                            <div className="flex items-center gap-3">
                                                <div className="h-9 w-9 rounded-xl bg-violet-100 flex items-center justify-center text-violet-600 font-bold text-xs">
