        ...
        <div className="space-y-10 pb-12 overflow-x-hidden">
            ...
            <div className="grid lg:grid-cols-3 gap-8">
                <div className="lg:col-span-2">
                    <div className="h-full bg-gradient-to-br from-orange-600 via-orange-500 to-rose-500 rounded-[3rem] p-12 text-white shadow-[0_30px_60px_-15px_rgba(249,115,22,0.3)] dark:shadow-none relative overflow-hidden group">
                        ...
                        <div className="relative z-10 flex flex-col h-full justify-between">
                            ...
                            <div className="flex flex-wrap gap-4 pt-10">
                                ...
                                <Button
                                    ...
                                    className="h-16 px-10 bg-white hover:bg-slate-50 text-orange-600 font-extrabold rounded-[1.5rem] flex-1 shadow-2xl uppercase tracking-widest text-[11px] transition-all active:scale-95 border-none"
                                >
                ...
                <div className="flex flex-col gap-6">
                    <Card className="rounded-[2.5rem] border-slate-100 dark:border-slate-800 bg-white dark:bg-slate-900/50 dark:backdrop-blur-sm shadow-xl shadow-slate-200/50 dark:shadow-none overflow-hidden flex-1 group hover:border-orange-200 transition-all">
                        <CardContent className="p-8">
                            <div className="flex items-center justify-between mb-8">
                                <div className="w-14 h-14 rounded-2xl bg-orange-100 dark:bg-orange-900/20 text-orange-600 dark:text-orange-400 flex items-center justify-center group-hover:scale-110 transition-transform">
                        ...
                        <CardContent className="p-12 lg:p-16">
                            <div className="flex items-center gap-4 mb-14">
                                ...
                                <div>
                                    ...
                                    <p className="text-[10px] font-black text-slate-400 uppercase tracking-[0.3em] mt-2">Güvenli Ödeme ve Bakiye Yükleme</p>
                                </div>
                            </div>
                            ...
                            <form onSubmit={handleSubmit} className="space-y-10">
                                ...
                                <div className="space-y-4">
                                            ...
                                            <button
                                                ...
                                                className={cn(
                                                    ...
                                                    amount === v.toString()
                                                        ...
                                                        : "border-slate-100 dark:border-slate-800 text-slate-400 hover:border-orange-200"
                                                )}
                                            >
                                                {v}₺
                                            </button>
                                    ...
                                    <div className="relative">
                                        ...
                                        <input
                                            ...
                                            className="w-full h-20 pl-14 pr-8 rounded-[1.8rem] bg-slate-50 dark:bg-slate-800/40 border-none text-2xl font-black text-slate-900 dark:text-white focus:ring-4 focus:ring-orange-500/10 transition-all shadow-inner"
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="relative">
                                        <button
                                            ...
                                            className="w-full h-16 px-6 rounded-2xl bg-slate-50 dark:bg-slate-800/40 flex items-center justify-between border-2 border-transparent hover:border-orange-200 transition-all group"
                                        >
                                ...
                                <div className="space-y-6">
                                    <div className="space-y-4">
                                        ...
                                        <div className="relative">
                                            <input
                                                ...
                                                className="w-full h-16 px-6 pt-2 rounded-2xl bg-slate-50 dark:bg-slate-800/40 border-none font-mono tracking-[0.3em] font-black text-lg text-slate-900 dark:text-white focus:ring-4 focus:ring-orange-500/10 placeholder:tracking-normal placeholder:font-sans placeholder:text-sm"
                                    ...
                                    <input
                                        ...
                                        className="w-full h-16 px-6 rounded-2xl bg-slate-50 dark:bg-slate-800/40 border-none uppercase font-black text-sm text-slate-900 dark:text-white focus:ring-4 focus:ring-orange-500/10"
                                    ...
                                    <div className="grid grid-cols-2 gap-6">
                                        <input
                                            ...
                                            className="h-16 px-6 rounded-2xl bg-slate-50 dark:bg-slate-800/40 border-none font-black text-center tracking-widest text-slate-900 dark:text-white focus:ring-4 focus:ring-orange-500/10"
                                            placeholder="MM / YY"
                                        />
                                        <input
                                            type="text"
                                ...
                                <Button
                                    type="submit"
                                    className="w-full h-20 bg-gradient-to-r from-orange-600 to-orange-500 hover:scale-[1.02] active:scale-[0.98] text-white rounded-[1.8rem] text-lg font-black mt-8 shadow-[0_20px_40px_-10px_rgba(249,115,22,0.4)] uppercase tracking-[0.2em] transition-all flex items-center justify-center gap-4"
                                >
                        ...
                        <div className="p-12 lg:p-14 bg-slate-50/50 dark:bg-slate-950/20 rounded-[4rem] border-2 border-dashed border-slate-100 dark:border-slate-800 flex flex-col items-center justify-center gap-10">
                            ...
                            <div className="text-center space-y-2">
                                ...
                                <div className="flex items-center justify-center gap-2">
                                    ...
                                    <span className="text-[9px] font-black text-slate-500 uppercase">SSL AKTİF</span>
                                </div>
                            </div>
                        </div>
