            ...
            <div className="bg-white rounded-3xl max-w-4xl w-full max-h-[90vh] overflow-y-auto shadow-2xl">
                ...
                <div className="px-8 py-4 bg-slate-50">
                    <div className="flex items-center justify-center gap-2">
                        <div className={`w-8 h-8 rounded-full flex items-center justify-center text-sm font-bold ${step >= 1 ? 'bg-violet-600 text-white' : 'bg-slate-200 text-slate-500'}`}>1</div>
                        <div className={`w-16 h-1 ${step >= 2 ? 'bg-violet-600' : 'bg-slate-200'}`} />
                        <div className={`w-8 h-8 rounded-full flex items-center justify-center text-sm font-bold ${step >= 2 ? 'bg-violet-600 text-white' : 'bg-slate-200 text-slate-500'}`}>2</div>
                        <div className={`w-16 h-1 ${step >= 3 ? 'bg-violet-600' : 'bg-slate-200'}`} />
                        <div className={`w-8 h-8 rounded-full flex items-center justify-center text-sm font-bold ${step >= 3 ? 'bg-violet-600 text-white' : 'bg-slate-200 text-slate-500'}`}>3</div>
                    </div>
                </div>
                            ...
                            {platforms.map((platform) => {
                                ...
                                return (
                                    <button
                                        ...
                                        className="p-6 rounded-2xl border-2 border-slate-200 hover:border-violet-500 hover:shadow-lg transition-all group"
                                    >
                                ...
                                {selectedPlatform.taskTypes.map((taskType) => {
                                    ...
                                    return (
                                        <button
                                            ...
                                            className="p-6 rounded-2xl border-2 border-slate-200 hover:border-violet-500 hover:shadow-lg transition-all group text-left"
                                        >
                    ...
                    {step === 3 && (
                        <div className="space-y-6">
                            ...
                            <Button
                                ...
                                className="w-full bg-gradient-to-r from-violet-600 to-purple-600 hover:from-violet-700 hover:to-purple-700 text-white rounded-xl h-12 text-base font-bold disabled:opacity-50 disabled:cursor-not-allowed"
                            >
                                Görevi Oluştur
                            </Button>
                        </div>
